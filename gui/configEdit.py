...
class Ui_configEdit(object):
    def setupUi(self, configEdit):
        ...
        self.backgroundVolume.setStyleSheet("background-color: rgb(255, 255, 255);")
        ...
        self.refreshAnnounceButton = QtWidgets.QPushButton(self.centralwidget)
        self.refreshAnnounceButton.setObjectName("refreshAnnounceButton")
        self.verticalLayout_2.addWidget(self.refreshAnnounceButton)
        ...
        self.refreshBackgroundButton = QtWidgets.QPushButton(self.centralwidget)
        self.refreshBackgroundButton.setObjectName("refreshBackgroundButton")
        self.verticalLayout.addWidget(self.refreshBackgroundButton)
        ...
        self.refreshAnnounceButton.clicked.connect(configEdit.refreshAnnounceClicked)
        self.refreshBackgroundButton.clicked.connect(configEdit.refreshBackgroundClicked)
...
"File Manager"))
        self.refreshAnnounceButton.setText(_translate("configEdit", "Refresh"))
...
"File Manager"))
        self.refreshBackgroundButton.setText(_translate("configEdit", "Refresh"))
